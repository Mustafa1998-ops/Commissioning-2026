...
Task 6.4: theHarvester Output (OSINT)
Deployed theHarvester to scrape public sources (search engines, example.com) for exposed email addresses, subdomains, and employee names.
Sanitized Command & Output:
Bash
$ theHarvester -d [TARGET_DOMAIN].com -b example.com
...
Bash# Executing a stealth SYN scan with service enumeration and OS detection across all ports
